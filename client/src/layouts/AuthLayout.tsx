 ...
 * @returns {React.JSX.Element} The rendered authentication layout.
 */
export default function AuthLayout({
  ...
  return (
    <div className="flex h-screen w-full bg-zinc-950 font-sans antialiased text-zinc-100 overflow-hidden">
